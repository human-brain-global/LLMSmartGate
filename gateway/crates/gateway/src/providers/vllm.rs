...
mod tests {
    ...
    fn test_route_with_auth(base_url: &str) -> ProviderRoute {
        ProviderRoute {
            id: RouteId::new(),
            tenant_id: None,
            ...
            config: serde_json::json!({"base_url": base_url, "api_key": "vllm-key"}),
            created_at: chrono::Utc::now(),
            updated_at: chrono::Utc::now(),
        }
    }

    fn test_route_no_auth(base_url: &str) -> ProviderRoute {
        ProviderRoute {
            id: RouteId::new(),
            tenant_id: None,
            model_alias: "llama-3".into(),
